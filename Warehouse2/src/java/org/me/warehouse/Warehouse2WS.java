 ...
 */
@WebService(serviceName = "Warehouse2WS")
public class Warehouse2WS {

    @Resource private WebServiceContext wsc;
    private static int orderNum=0;
    private static int THRESHOLD = 20;
    private final int REPLENISH_AMOUNT = 100;
    private final String SELF = "Warehouse_Dos";
    ...
    public ShippedList shipGoods(@WebParam(name = "items") OrderList items) {
        ...
        System.out.println("SIZE OF ITEMS: " + items.getItems().get(0).getProduct().getProductName());
