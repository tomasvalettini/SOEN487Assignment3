 ...
 * 
 */
@WebService(name = "Manufacturer3WS", targetNamespace = "http://manufacturer.me.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Manufacturer3WS {
    ...
    @Action(input = "http://manufacturer.me.org/Manufacturer3WS/receivePaymentRequest", output = "http://manufacturer.me.org/Manufacturer3WS/receivePaymentResponse")
    ...
    @Action(input = "http://manufacturer.me.org/Manufacturer3WS/processPurchasePrderRequest", output = "http://manufacturer.me.org/Manufacturer3WS/processPurchasePrderResponse")
    ...
    @Action(input = "http://manufacturer.me.org/Manufacturer3WS/getProductInfoRequest", output = "http://manufacturer.me.org/Manufacturer3WS/getProductInfoResponse")
